...
import 'package:myapp/Screens/Admin/academics/webinars/admin_webinars.dart';
import 'package:myapp/Screens/Admin/academics/webinars/admin_webinars_card.dart';
import 'package:myapp/Screens/Admin/academics/webinars/admin_webinars_stackoverflow.dart';
...
class AdminAcademics extends StatelessWidget {
// final String name;
  const AdminAcademics({Key? key}) : super(key: key);
          ...
          InkWell(
            onTap: (() {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => AdminWebinarsCard()));
            }),
            // ignore: avoid_unnecessary_containers
            child: Container(
              //margin: EdgeInsets.all(10),
