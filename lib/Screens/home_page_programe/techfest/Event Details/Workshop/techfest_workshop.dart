...
class TechfestWorkshop extends StatelessWidget {
  const TechfestWorkshop({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Text('Display the worksops and their respective dvpt'),
    );
  }
}
