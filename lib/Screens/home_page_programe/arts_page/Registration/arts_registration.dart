...
class ArtsRegistration extends StatelessWidget {
  const ArtsRegistration({Key? key}) : super(key: key);
          ...
          InkWell(
            onTap: (() {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const ArtsRegistrationOffstageEvents()));
            }),
          ...
          InkWell(
            onTap: (() {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const ArtsRegistrationOnstageEvents()));
            }),
            // ignore: avoid_unnecessary_containers
            child: Container(
              //margin: EdgeInsets.all(10),
          ...
          InkWell(
            onTap: (() {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const ArtsRegistrationVolunteers()));
            }),
            // ignore: avoid_unnecessary_containers
            child: Container(
              //margin: EdgeInsets.all(10),
