...
class ArtsEventsListOffstage extends StatelessWidget {
  const ArtsEventsListOffstage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Text(
          'Display the list of the offstage events and the rules related to them'),
    );
  }
}
